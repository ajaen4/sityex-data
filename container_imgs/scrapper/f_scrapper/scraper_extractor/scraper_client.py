...
class ScraperClient:
    ...
    def scrape_content(
        self, scrape_cfg: ScrapeConfig, override_url_path: str = ""
    ) -> list:
        scrape_elems = scrape_cfg.scrape_elems

        url_path = (
            override_url_path if override_url_path else scrape_cfg.url_path
        )
