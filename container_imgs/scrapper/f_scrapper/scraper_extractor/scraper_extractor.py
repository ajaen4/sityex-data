...
class ScraperExtractor:
    ...
    def get_content(
        ...
        url_path = ScraperExtractor.get_url_path(
            scrape_cfg.url_path, extra_args
        )
        scraped_content = self.scrape_client.scrape_content(
            scrape_cfg, url_path
        )
    ...
    @staticmethod
    def get_file_name(file_name: str, extra_args: dict[str, str] = {}) -> str:
        if extra_args:
    ...
    @staticmethod
    def get_url_path(url_path: str, extra_args: dict[str, str] = {}) -> str:
        if extra_args:
